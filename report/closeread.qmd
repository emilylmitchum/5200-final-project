...
This is more than just an anecdotal observation. In 1995, political scientist Christopher Wliezein found something he called the thermostatic model of public opinion. 

@cr-two_party

Wliezein found that the public acts as a thermostat, adjusting its political demands in response to government action. When policies become too liberal, public opinion moves to the right; if they become too conservative, the public moves left. 

Through this mechanism, the public provides necessary feedback for democratic accountability. 
...
As a reminder, the 19th amendment essentially gave women the right to vote. After decades of the women’s suffrage movement, the 19th amendment passed, prohibiting elections from denying citizens the right to vote on the basis of sex.[@partridge2025]
...
The National Public Opinion Reference Survey is an annual survey of adults in the United States, distributed by Pew Research. [@Piccorossi_2021] From 2020 to 2025, survey respondents were asked what political party they identify with. The following chart shows those responses over time. 
:::
...
:::{#cr-repeal-19th-3}
![](charts/repeal-19th-3.png){width="70%"}
:::

:::{#cr-repeal-19th-4}
![](charts/repeal-19th-4.png){width="60%"}
:::

:::{#cr-two_party}
![](charts/two_party.jpg){width="60%"}
:::

:::{#cr-white_house}
![](charts/white_house.jpg){width="80%"}
:::
...
:::{#cr-features-gender_split_2}
![@wikimedia2024](charts/election2024.jpg)
:::
...
A Pew research study @pew2024 found that women in opposite-sex marriages are far more likely than men to take their spouse’s last name, though younger, Democratic and highly-educated women are less likely to do so. For women with birth certificates that do not match their current legal names, registering to vote would necessitate additional documentation, such as a marriage certificate.
:::
...
:::{#cr-features-ma_wv_comparison}
![](charts/ma_wv_comparison_clean.png)
:::
...
The social media backlash experienced by young female voters and calls to repeal the 19th Amendment provide a small window into the ideal world of far-right extremist men, where women have no political say. 

The SAVE Act and similar, state-level voter registration laws show a more realistic view of women’s voter suppression, where fewer women are able to vote, and some may choose not to due to prohibitive barriers. 
...
If enough individuals decided to stay home, instead of booking the flight, finding the marriage certificate, or getting the passport, what would our country look like?
